...
<html prefix="og: http://ogp.me/ns#">
    <head>
        ...
        <title>Pyimagesearch.coms &middot; My Name</title>
        ...
        <meta property="og:title" content="Pyimagesearch.coms">
<meta property="og:description" content="Ghostwriter example description">
<meta property="og:type" content="website">
<meta property="og:url" content="https://example.com/pyimagesearch/index.com/">
...
<div id="post-index" class="container">
    ...
    <header class="post-header">
        <h1 class="post-title">Ghostwriter example</h1>
        <p>Ghostwriter example description</p>
    </header>
    ...
    <ol class="post-list">
            ...
            <li class="post-stub">
    <a href="https://example.com/pyimagesearch.com/">
        <h4 class="post-stub-title">A good resource on image processing using Python</h4>
